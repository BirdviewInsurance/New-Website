...
import ContactUs from './pagesComps/DataCollectionForm';
import MainNavigation from './pagesComps/Dashboard';
import Footer from './components/Footer';
import Head from 'next/head'; 

const MainDataCollection = () => {
  return (
    <>
      <Head>
        {/* Page Title */}
        <title>Data Collection Form - Birdview Microinsurance | Get in Touch with Us</title>
