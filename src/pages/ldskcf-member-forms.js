...
import LDSKCFMemberForm from './pagesComps/LDSKCFMemberForm';
import MainNavigation from './pagesComps/Dashboard';
import Footer from './components/Footer';
import Head from 'next/head'; 

const MainLDSKCFMemberForm = () => {
  return (
    <>
      <Head>
        {/* Page Title */}
        <title>LDSKCF Member Form - Birdview Microinsurance | Get in Touch with Us</title>
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "name": "Member Form  - Birdview Microinsurance",
...
export default MainLDSKCFMemberForm;
