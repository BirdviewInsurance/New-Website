...
import RequestForms from './pagesComps/RequestForms';
...
const MainContactUs = () => {
  return (
    <>
      <Head>
        {/* Page Title */}
        <title>Request Forms  - Birdview Microinsurance | Get in Touch with Us</title>
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "name": "Contact Us - Birdview Insurance",
