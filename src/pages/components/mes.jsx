...
const VideoSlider = () => {
  ...
  otherSlides.sort((a, b) => new Date(b.date) - new Date(a.date));
  
  const slides = [featuredSlide, ...otherSlides];
  ...
  return (
    <div className="relative w-full">
        ...
        {slides.map((slide, index) => (
          <div key={index}>
            <div className="relative w-full h-[450px] bg-black overflow-hidden rounded-md">
              ...
              <div className="absolute bottom-0 w-full flex flex-col items-center justify-center bg-black bg-opacity-50 p-4 md:p-6">
              <h6 className="text-center text-[1.4rem] md:text-[1.85rem] font-bold leading-snug text-white px-4 md:px-12 max-w-5xl mx-auto tracking-tight drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
      ...
      <div className={` ${isSmallScreen ? 'hidden' : 'block'} absolute top-1/2 left-8 transform -translate-y-1/2 flex items-center justify-center`}>
        <Pagination
          count={slides.length}
          page={currentSlide + 1}
