...
import StaffMedicalForm from './pagesComps/StaffMedicalForm';
import MainNavigation from './pagesComps/Dashboard';
import Footer from './components/Footer';
import Head from 'next/head'; 

const MainStaffMedicalForm = () => {
  return (
    <>
      <Head>
        {/* Page Title */}
        <title>Staff Medical Form - Birdview Microinsurance | Get in Touch with Us</title>
        ...
        <meta
          name="keywords"
          content="Contact Birdview Microinsurance,Birdview,Birdview , Microinsurance,Insurance, Birdview Kenya, Birdview Insurance, Insurance inquiries, Get in touch, Customer support, Reach Birdview MicroInsurance, Insurance support, Insurance questions, How to contact Birdview"
        />
        ...
        <meta property="og:title" content="Member Form  - Birdview Microinsurance" />
        <meta
        ...
        <meta property="og:site_name" content="Birdview Insurance" />

        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content=" - Birdview Microinsurance" />
        <meta
        ...
        <meta property="og:title" content="Member Form  - Birdview Microinsurance on LinkedIn" />
        <meta property="og:url" content="https://www.linkedin.com/company/birdviewmicroinsurance" />
        <meta property="og:image" content="https://www.birdviewmicroinsurance.com/favicon.ico" />
        <meta property="og:description" content="Contact Birdview MicroInsurance via LinkedIn for insurance inquiries." />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "name": "Staff Medical Form  - Birdview Microinsurance",
...
export default MainStaffMedicalForm;
