...
useEffect(() => {
    const generatePolicyScheme = () => {
      return "Birdview Microinsurance Medical Scheme";
    };
  
    setFormData((prev) => ({ ...prev, policyScheme: generatePolicyScheme() }));
  }, []);
  ...
  useEffect(() => {
    ...
    setFormData((prev) => ({ ...prev, relationship: generateRelationship() }));
  }, []);
  ...
  useEffect(() => {
    ...
    setFormData((prev) => ({ ...prev, country: generateCountry() }));
  }, []);
...
const handleOpenDialog = (dependant) => {
...
const [openDependantPopup, setOpenDependantPopup] = useState(false);
          ...
          {/* Form Section */}
                        ...
                        >
                          ...
                          <div className="mt-2 sm:mt-0 sm:absolute sm:left-1/2 sm:transform sm:-translate-x-1/2">
                            <p>Staff Medical Detail Forms</p>
                          </div>
                        </div>
                            ...
                            <Dialog open={openDialog} onClose={handleCloseDialog}>
                                ...
                                <FormControl fullWidth margin="dense">
                                    ...
                                    <TextField
                                            ...
                                            className="bg-gray-100 rounded-lg"
                                            >
                                              {["Mr", "Mrs", "Miss", "Dr", "Prof", "Ms", "Master"].map((title) => (
                                                <MenuItem key={title} value={title}>
                                                  {title}
                                                </MenuItem>
                                              ))}
